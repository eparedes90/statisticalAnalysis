...
ad <- readRDS("E:/Asesorías de tesis/Economía/Eficiencia del gasto público en la educación/for_analysis/ad.Rdta")
...
# 
# 
# #Corrección de heteroscedasticidad White
...
# 
# ##MODELO SIN NIVELURB y CON TÉRMINO AL CUADRADO
...
#read new data3
alumDocProxy <- readxl::read_xlsx("E:/Asesorías de tesis/Economía/Eficiencia del gasto público en la educación/data3/alumDocProxy.xlsx")
schooling <- readxl::read_xlsx("E:/Asesorías de tesis/Economía/Eficiencia del gasto público en la educación/data3/schooling.xlsx")
